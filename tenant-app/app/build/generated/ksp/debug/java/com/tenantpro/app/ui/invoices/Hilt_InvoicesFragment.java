...
public abstract class Hilt_InvoicesFragment extends Fragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_InvoicesFragment() {
    super();
  }

  Hilt_InvoicesFragment(int p0) {
    super(p0);
  }
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((InvoicesFragment_GeneratedInjector) this.generatedComponent()).injectInvoicesFragment(UnsafeCasts.<InvoicesFragment>unsafeCast(this));
    }
  }
