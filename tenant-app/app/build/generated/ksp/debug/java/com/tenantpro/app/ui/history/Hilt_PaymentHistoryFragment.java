...
public abstract class Hilt_PaymentHistoryFragment extends Fragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_PaymentHistoryFragment() {
    super();
  }

  Hilt_PaymentHistoryFragment(int p0) {
    super(p0);
  }
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((PaymentHistoryFragment_GeneratedInjector) this.generatedComponent()).injectPaymentHistoryFragment(UnsafeCasts.<PaymentHistoryFragment>unsafeCast(this));
    }
  }
