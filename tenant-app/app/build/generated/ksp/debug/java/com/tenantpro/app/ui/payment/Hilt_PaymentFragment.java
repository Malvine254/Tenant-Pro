...
public abstract class Hilt_PaymentFragment extends Fragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_PaymentFragment() {
    super();
  }

  Hilt_PaymentFragment(int p0) {
    super(p0);
  }
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((PaymentFragment_GeneratedInjector) this.generatedComponent()).injectPaymentFragment(UnsafeCasts.<PaymentFragment>unsafeCast(this));
    }
  }
