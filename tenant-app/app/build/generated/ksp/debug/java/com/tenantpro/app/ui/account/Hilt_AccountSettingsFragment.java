...
public abstract class Hilt_AccountSettingsFragment extends Fragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_AccountSettingsFragment() {
    super();
  }

  Hilt_AccountSettingsFragment(int p0) {
    super(p0);
  }
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((AccountSettingsFragment_GeneratedInjector) this.generatedComponent()).injectAccountSettingsFragment(UnsafeCasts.<AccountSettingsFragment>unsafeCast(this));
    }
  }
