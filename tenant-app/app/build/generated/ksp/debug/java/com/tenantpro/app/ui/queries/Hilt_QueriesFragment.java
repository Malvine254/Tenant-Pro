...
public abstract class Hilt_QueriesFragment extends Fragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_QueriesFragment() {
    super();
  }

  Hilt_QueriesFragment(int p0) {
    super(p0);
  }
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((QueriesFragment_GeneratedInjector) this.generatedComponent()).injectQueriesFragment(UnsafeCasts.<QueriesFragment>unsafeCast(this));
    }
  }
