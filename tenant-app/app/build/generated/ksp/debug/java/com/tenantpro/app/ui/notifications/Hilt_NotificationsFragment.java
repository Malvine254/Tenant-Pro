...
public abstract class Hilt_NotificationsFragment extends Fragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_NotificationsFragment() {
    super();
  }

  Hilt_NotificationsFragment(int p0) {
    super(p0);
  }
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((NotificationsFragment_GeneratedInjector) this.generatedComponent()).injectNotificationsFragment(UnsafeCasts.<NotificationsFragment>unsafeCast(this));
    }
  }
