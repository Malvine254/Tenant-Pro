...
public final class ItemQueryChatOutgoingBinding implements ViewBinding {
  ...
  @NonNull
  public static ItemQueryChatOutgoingBinding inflate(@NonNull LayoutInflater inflater) {
  ...
  public static ItemQueryChatOutgoingBinding inflate(@NonNull LayoutInflater inflater,
    ...
    View root = inflater.inflate(R.layout.item_query_chat_outgoing, parent, false);
    if (attachToParent) {
      parent.addView(root);
    }
    return bind(root);
  ...
  @NonNull
  public static ItemQueryChatOutgoingBinding bind(@NonNull View rootView) {
