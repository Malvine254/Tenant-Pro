...
public abstract class Hilt_MaintenanceFragment extends Fragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_MaintenanceFragment() {
    super();
  }

  Hilt_MaintenanceFragment(int p0) {
    super(p0);
  }
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((MaintenanceFragment_GeneratedInjector) this.generatedComponent()).injectMaintenanceFragment(UnsafeCasts.<MaintenanceFragment>unsafeCast(this));
    }
  }
