...
public abstract class Hilt_RentalInfoFragment extends Fragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_RentalInfoFragment() {
    super();
  }

  Hilt_RentalInfoFragment(int p0) {
    super(p0);
  }
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((RentalInfoFragment_GeneratedInjector) this.generatedComponent()).injectRentalInfoFragment(UnsafeCasts.<RentalInfoFragment>unsafeCast(this));
    }
  }
