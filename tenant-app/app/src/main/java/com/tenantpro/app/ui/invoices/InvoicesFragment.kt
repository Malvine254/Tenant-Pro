...
class InvoicesFragment : Fragment() {
    ...
    private fun exportInvoiceGroupPdf(group: InvoiceGroup) {
        try {
            ...
            val filename = "Starmax_Tenant_Services_Invoice_$safe.pdf"
    ...
    private fun drawInvoiceGroupPage(
        ...
        canvas.drawText("Starmax Tenant Services", left, 35f, p(22f, Color.WHITE, true))
        ...
        canvas.drawText("Generated securely by Starmax Tenant Services", left, 805f, p(9f, muted))
    }
    ...
    private fun drawInvoicePage(canvas: Canvas, invoice: Invoice) {
        ...
        canvas.drawText("Starmax Tenant Services", m, 35f,
        ...
        canvas.drawText("Generated by Starmax Tenant Services  •  $today", m, y,
