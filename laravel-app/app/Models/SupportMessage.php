...
class SupportMessage extends Model
{
    ...
    protected $fillable = [
        ...
        'is_from_tenant', 'is_ai', 'tool_calls', 'status', 'delivered_at', 'read_at',
    ];

    protected $casts = ['is_from_tenant' => 'boolean', 'is_ai' => 'boolean', 'tool_calls' => 'array', 'delivered_at' => 'datetime', 'read_at' => 'datetime'];
