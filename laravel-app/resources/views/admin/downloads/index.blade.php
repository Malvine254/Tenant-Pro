    ...
    <div class="card" style="margin-bottom:20px;">
        ...
        @if($apkExists)
            ...
            <div style="display:flex;gap:10px;flex-wrap:wrap;">
                <a href="{{ route('downloads.apk.download') }}" class="btn btn-primary" download="app-debug.apk">
                    📱 Download APK (Admin)
                </a>
                <a href="{{ route('downloads.apk.public') }}" class="btn btn-secondary" download="app-debug.apk">
                    🔗 Public Link
                </a>
            </div>
