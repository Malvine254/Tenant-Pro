...
<aside class="sidebar" id="adminSidebar" aria-hidden="true">
    ...
    <nav aria-label="Primary navigation">
        ...
        @unless($isCaretaker)
            ...
            <a href="{{ route('admin.financials.index') }}" class="{{ request()->routeIs('admin.financials*') ? 'active' : '' }}"><i class="nav-icon"><svg viewBox="0 0 24 24"><path d="M12 2v20M17 5H9.5a3.5 3.5 0 0 0 0 7h5a3.5 3.5 0 0 1 0 7H6"/></svg></i><span>Financials &amp; Expenses</span></a>
            <a href="{{ route('admin.inspections.index') }}" class="{{ request()->routeIs('admin.inspections*') ? 'active' : '' }}"><i class="nav-icon"><svg viewBox="0 0 24 24"><path d="M9 11l3 3L22 4"/><path d="M21 12v7a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2V5a2 2 0 0 1 2-2h11"/></svg></i><span>Condition Reports</span></a>
        @endunless
