...
<aside class="sidebar" id="adminSidebar" aria-hidden="true">
    ...
    <nav aria-label="Primary navigation">
        ...
        @unless($isCaretaker)
            ...
            <a href="{{ route('admin.financials.index') }}" class="{{ request()->routeIs('admin.financials*') ? 'active' : '' }}"><i class="nav-icon"><svg viewBox="0 0 24 24"><path d="M3 3v18h18"/><path d="m19 9-5 5-4-4-3 3"/><path d="M14 9h5v5"/></svg></i><span>Financials</span></a>
