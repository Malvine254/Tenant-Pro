...
<div style="max-width:380px;margin:60px auto;">
    <div class="card">
        ...
        @if(session('status'))<div style="margin-bottom:14px;color:#bbf7d0;font-size:13px;">{{ session('status') }}</div>@endif
        <form method="POST" action="{{ route('admin.password.email') }}">
            ...
            <button type="submit" class="btn btn-primary" style="width:100%;padding:10px;">Email reset link</button>
        </form>
