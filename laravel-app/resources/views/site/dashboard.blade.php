...
<div class="section" style="text-align:center;padding:60px 0;">
    ...
    <p style="max-width:420px;margin:8px auto 24px;">Access the Starmax Tenant Services admin console to manage properties, tenants, invoices, and maintenance workflows.</p>
