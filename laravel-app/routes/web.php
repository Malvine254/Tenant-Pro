...
use App\Http\Controllers\Admin\PropertyExpenseAdminController;
use App\Http\Controllers\Admin\PropertyInspectionAdminController;
...
Route::prefix('admin')->name('admin.')->middleware('admin.security')->group(function () {
    ...
    Route::middleware(['auth', 'admin.role:SUPER_ADMIN,ADMIN,LANDLORD', 'admin.audit', 'admin.readiness'])->group(function () {
        ...
        Route::post('/invoices/{invoice}/remind', [InvoiceAdminController::class, 'sendReminder'])->name('invoices.remind');
        Route::get('/payments', [PaymentAdminController::class, 'index'])->name('payments.index');
        Route::get('/payments/{payment}/receipt-pdf', [PaymentAdminController::class, 'receiptPdf'])->name('payments.receipt-pdf');
        Route::get('/financials', [PropertyExpenseAdminController::class, 'index'])->name('financials.index');
        Route::post('/expenses', [PropertyExpenseAdminController::class, 'store'])->name('expenses.store');
        Route::delete('/expenses/{expense}', [PropertyExpenseAdminController::class, 'destroy'])->name('expenses.destroy');
        Route::get('/inspections', [PropertyInspectionAdminController::class, 'index'])->name('inspections.index');
        Route::get('/inspections/create', [PropertyInspectionAdminController::class, 'create'])->name('inspections.create');
        Route::post('/inspections', [PropertyInspectionAdminController::class, 'store'])->name('inspections.store');
        Route::get('/inspections/{inspection}', [PropertyInspectionAdminController::class, 'show'])->name('inspections.show');
        Route::get('/inspections/{inspection}/pdf', [PropertyInspectionAdminController::class, 'pdf'])->name('inspections.pdf');
